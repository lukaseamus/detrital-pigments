...
gaussian.peaks <- read.table("~/Desktop/Projects/QUB/Data/Pigment deconvolution/gaussian.peak.parameters.txt", header = TRUE) 

# Specific absorption coefficient (sac) file including alias pigments (zea, cryp, anth)
sac.table <- read.table("~/Desktop/Projects/QUB/Data/Pigment deconvolution/specific.absorption.coefficients.txt", header = TRUE)
