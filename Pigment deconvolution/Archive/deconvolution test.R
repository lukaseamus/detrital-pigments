...
s <- read.csv("~/Desktop/Projects/QUB/Data/Pigment deconvolution/spectra test.csv", header = T)
...
# Read sample weights
mass <- read.csv("~/Desktop/Projects/QUB/Data/Pigment deconvolution/mass test.csv", header = T)
...
write.csv(ug.g, "~/Desktop/Projects/QUB/Data/Pigment deconvolution/Raw pigments test.csv")
